                ...
                <ul className="space-y-1">
                    ...
                    <li>
                        ...
                        <ul id="submenu-users" className={`${openSubmenus['submenu-users'] ? '' : 'hidden'} py-1 space-y-1 pl-4`}>
                            ...
                            <li><NavLink to="/bo/users/school-users" className={getSubmenuLinkClass} onClick={onClose}><i className="ri-user-2-line"></i><span>MySertifico Users</span></NavLink></li>
                    ...
                    <li>
                        ...
                        <ul id="submenu-admin" className={`${openSubmenus['submenu-admin'] ? '' : 'hidden'} py-1 space-y-1 pl-4`}>
                            ...
                            <li><NavLink to="/bo/admin/plans-subscription" className={getSubmenuLinkClass} onClick={onClose}><i className="ri-shopping-cart-2-line"></i><span>Plans & Subscriptions</span></NavLink></li>

            ...
            <form onSubmit={handleSubmit}>
                <div className="p-6 border-b border-primary-800/50">
                    <div className="flex items-center justify-between">
                        ...
                        <NavLink to="/mywall/parent-myprofile" className="text-primary-200 hover:text-white transition-colors" title="Back to Profile">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <fieldset className="space-y-4">
                        <legend className="text-lg font-semibold text-primary-300 mb-2">Personal Information</legend>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label htmlFor="nationalId" className="block text-sm font-medium text-primary-200 mb-1">National ID / Passport No.</label>
                            ...
                            <div>
                                <label htmlFor="phone" className="block text-sm font-medium text-primary-200 mb-1">Phone Number</label>
                            ...
                            <div>
                                <label htmlFor="country" className="block text-sm font-medium text-primary-200 mb-1">Country</label>
                            ...
                            <div className="md:col-span-2">
                                <label htmlFor="email" className="block text-sm font-medium text-primary-200 mb-1">Email</label>
                                <input type="email" id="email" name="email" value={profile.email} required className="w-full px-4 py-2 bg-white/10 text-primary-300 rounded-lg border-2 border-transparent focus:outline-none cursor-not-allowed" disabled />
                            </div>
                            {/* ... more fields ... */}
                        </div>
                    </fieldset>
                    ...
                    <fieldset className="space-y-4">
                        <legend className="text-lg font-semibold text-primary-300 mb-2">Professional Information</legend>
                        <div>
                            <label htmlFor="aboutMe" className="block text-sm font-medium text-primary-200 mb-1">About Me</label>
                        ...
                        <div>
                            <label htmlFor="skills" className="block text-sm font-medium text-primary-200 mb-1">Skills (comma separated)</label>
                        ...
                        <div>
                            <label htmlFor="linkedin" className="block text-sm font-medium text-primary-200 mb-1">LinkedIn URL</label>

        ...
        <header className="bg-white shadow-md text-gray-800 fixed w-full top-0 z-50">
            <nav className="container mx-auto px-6 py-3">
                <div className="flex items-center justify-between">
                    <a href="parent-wall.html" className="flex items-center gap-2">
                    ...
                    <div className="relative" ref={menuRef}>
                        ...
                        {!isMenuOpen ? null : (
                            <div id="profile-menu" className="absolute top-full right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50">
                                <a href="parent-wall.html" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary"><i className="ri-layout-grid-fill mr-3"></i>MyWall</a>
                                <a href="parent-myprofile.html" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary"><i className="ri-user-line mr-3"></i>MyProfile</a>
                                <a href="myfamily.html" className="flex items-center px-4 py-2 text-sm text-primary font-bold bg-primary-50"><i className="ri-group-line mr-3"></i>MyFamily</a>
                                <a href="parent-myaccount.html" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary"><i className="ri-settings-3-line mr-3"></i>MyAccount</a>
                                <a href="parent-resume.html" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary"><i className="ri-article-line mr-3"></i>MyResume</a>

...
const Dashboard = ({ navigate }) => {
    ...
    return (
        <div className="bg-[#151c2c] dark:bg-[#151c2c] transition-colors duration-300 min-h-screen">
            {/* Sidebar */}
            <aside id="sidebar" className={`sidebar fixed top-0 left-0 z-50 h-full w-64 bg-[#1c2336] dark:bg-[#1c2336] text-white transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out overflow-y-auto lg:translate-x-0 lg:static lg:h-auto`}>
                <div className="flex items-center justify-between p-6">
                    <h2 className="font-poppins text-2xl font-bold text-[#3fe0c5]">MySertifico</h2>
                ...
                <nav className="p-4">
                    <ul className="space-y-2">
                        <li>
                            <a href="#" onClick={() => navigate('dashboard')} className="flex items-center py-2.5 px-4 rounded-lg bg-[#232b47] text-white font-semibold">
            ...
            <div id="main-content" className={`relative min-h-screen transition-all duration-300 ease-in-out ${isSidebarOpen ? 'lg:ml-64' : ''}`}>
                {/* Navbar */}
                <header className="sticky top-0 z-30 bg-[#1c2336] dark:bg-[#1c2336] shadow-sm border-b border-[#232b47]">
                    <div className="flex items-center justify-between p-4">
                        <div className="flex items-center space-x-4">
                            <button id="sidebar-toggle" className="text-gray-300 p-2 rounded-lg hover:bg-[#232b47] focus:outline-none lg:hidden" onClick={toggleSidebar}>
                            ...
                            <a href="#" onClick={() => navigate('dashboard')} className="flex items-center gap-x-2">
                                ...
                                <span className="font-poppins text-2xl font-bold text-[#3fe0c5] hidden sm:block">MySertifico</span>
                            </a>
                        </div>
                        <div className="flex items-center space-x-4">
                            <button id="theme-toggle" className="text-gray-300 p-2 rounded-lg hover:bg-[#232b47]" onClick={toggleTheme}>
                            ...
                            <div className="relative">
                                <button id="profile-menu-button" className="flex items-center space-x-2" onClick={toggleProfileMenu}>
                                    ...
                                    <div className="hidden md:block text-left">
                                        <div className="text-sm font-semibold text-white">Fikri Nabil</div>
                ...
                <main className="p-6 sm:p-8">
                    <div className="max-w-7xl mx-auto">
                        {/* Header */}
                        <div className="mb-8">
                            <h1 className="text-3xl font-bold text-white">Welcome back, Fikri Nabil!</h1>
                            <p className="text-gray-400 mt-1">Here's a summary of your organization's activity.</p>
                        </div>

                        {/* Call to Action: Create Certificate */}
                        <div className="mb-8">
                            <a href="#" className="block w-full text-center p-8 bg-[#ffc21a] text-white rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <i className="ri-add-circle-fill text-5xl"></i>
                                    <div>
                                        <h2 className="text-2xl font-bold">Create New Certificate</h2>
                                        <p className="text-white/80">Start issuing new certificates to your recipients now.</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
                            {/* Available Tokens */}
                            <div className="bg-[#1c2336] text-white p-6 rounded-xl shadow-lg flex flex-col justify-between">
                                <div>
                                    <div className="flex justify-between items-start">
                                        <h3 className="font-semibold text-lg text-[#3fe0c5]">Available Tokens</h3>
                                        <i className="ri-copper-coin-line text-4xl text-[#3fe0c5] opacity-70"></i>
                                    </div>
                                    <p className="text-4xl font-bold mt-2">8,750</p>
                                </div>
                                <a href="#" className="mt-4 block text-center text-sm font-semibold text-white bg-[#232b47] hover:bg-[#232b47]/80 py-2 px-4 rounded-lg transition-colors">Top-up Tokens</a>
                            </div>
                            {/* Certificates Issued */}
                            <div className="bg-[#232b47] p-6 rounded-xl shadow-md">
                                <div className="flex justify-between items-start">
                                    <h3 className="font-semibold text-gray-300">Certificates Issued</h3>
                                    <div className="p-2 bg-[#232b47] rounded-lg"><i className="ri-award-line text-xl text-[#3fe0c5]"></i></div>
                                </div>
                            ...
                            <div className="bg-[#232b47] p-6 rounded-xl shadow-md">
                                <div className="flex justify-between items-start">
                                    <h3 className="font-semibold text-gray-300">Total Recipients</h3>
                                    <div className="p-2 bg-[#232b47] rounded-lg"><i className="ri-group-line text-xl text-green-400"></i></div>
                                </div>
                                <p className="text-3xl font-bold text-white mt-2">4,820</p>
                                <p className="text-sm text-green-400 mt-1">+82 new recipients</p>
                            </div>
                            {/* Templates Used */}
                            <div className="bg-[#232b47] p-6 rounded-xl shadow-md">
                                <div className="flex justify-between items-start">
                                    <h3 className="font-semibold text-gray-300">Templates Used</h3>
                                    <div className="p-2 bg-[#232b47] rounded-lg"><i className="ri-layout-grid-line text-xl text-[#ffc21a]"></i></div>
                                </div>
                                <p className="text-3xl font-bold text-white mt-2">12</p>
                                <p className="text-sm text-gray-400 mt-1">Active templates</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            {/* Recent Activity */}
                            <div className="lg:col-span-2 bg-[#232b47] p-6 rounded-xl shadow-md">
                                <h3 className="text-xl font-bold text-white mb-4">Recent Activity</h3>
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        <div className="p-3 bg-[#1c2336] rounded-full"><i className="ri-file-add-line text-[#3fe0c5]"></i></div>
                                        <div className="flex-grow">
                                            <p className="text-white"><strong>150 certificates</strong> were issued for "Webinar Digital Marketing".</p>
                                            <p className="text-sm text-gray-400">2 hours ago</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="p-3 bg-[#1c2336] rounded-full"><i className="ri-user-add-line text-green-400"></i></div>
                                        <div className="flex-grow">
                                            <p className="text-white"><strong>50 new recipients</strong> were added via CSV import.</p>
                                            <p className="text-sm text-gray-400">1 day ago</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="p-3 bg-[#1c2336] rounded-full"><i className="ri-award-line text-[#3fe0c5]"></i></div>
                                        <div className="flex-grow">
                                            <p className="text-white">Certificate for <strong>Ahmad Zaki</strong> was viewed.</p>
                            ...
                            <div className="bg-[#232b47] p-6 rounded-xl shadow-md">
                                ...
                                <div className="space-y-3">
                                    <a href="#" className="w-full flex items-center gap-3 p-3 rounded-lg bg-[#1c2336] hover:bg-[#232b47] transition-colors">
                                        <i className="ri-user-add-line text-green-400 text-xl"></i>
                                        <span className="font-semibold text-white">Add Recipients</span>
                                    </a>
                                    <a href="#" className="w-full flex items-center gap-3 p-3 rounded-lg bg-[#1c2336] hover:bg-[#232b47] transition-colors">
                                        <i className="ri-layout-grid-line text-[#ffc21a] text-xl"></i>
                                        <span className="font-semibold text-white">View Templates</span>
                                    </a>
                                    <a href="#" className="w-full flex items-center gap-3 p-3 rounded-lg bg-[#1c2336] hover:bg-[#232b47] transition-colors">
                                        <i className="ri-image-line text-purple-400 text-xl"></i>
                                        <span className="font-semibold text-white">View Logos & Badges</span>
                                    </a>
                                </div>
                            </div>
                        </div>

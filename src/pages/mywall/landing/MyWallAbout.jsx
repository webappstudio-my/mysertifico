            ...
            <main className="pt-24 pb-12">
                ...
                <section className="py-16 text-center">
                    <div className="container mx-auto px-6">
                        ...
                        <p className="text-lg text-primary-200 mt-4 max-w-3xl mx-auto">Empowering every individual to own, manage, and share their lifelong achievements through a secure and beautiful digital portfolio.</p>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 transform hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <p className="text-primary-200">Your certificates are protected with top-tier security, ensuring they are authentic and tamper-proof.</p>
                            </div>
                            {/* Feature 2 */}
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 transform hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <p className="text-primary-200">Share your achievements with potential employers, universities, or on social media with a single, secure link.</p>
                            </div>
                            {/* Feature 3 */}
                            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 transform hover:-translate-y-2 transition-transform duration-300">
                                ...
                                <p className="text-primary-200">From your first school prize to your latest professional skill, MyWall is your companion for a lifetime of learning.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <p className="text-primary-200 mb-8 max-w-2xl mx-auto">Join thousands of students and professionals who are taking control of their achievements.</p>

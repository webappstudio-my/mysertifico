                ...
                <section className="pb-20 pt-8">
                    <div className="container mx-auto px-6">
                        <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-sm p-8 rounded-2xl shadow-lg prose prose-invert prose-p:text-teal-200 prose-headings:text-white prose-h2:border-b prose-h2:border-white/20 prose-h2:pb-2 prose-a:text-accent hover:prose-a:text-yellow-300">
                            <p className="mb-6">At MyWall, the security of our platform and your data is our highest priority. We employ a multi-layered security strategy to protect our infrastructure and your sensitive information from unauthorized access and cyber threats.</p>
                            ...
                            <p className="mb-4">Every digital certificate issued through MyWall is secured with a unique, verifiable QR code. This feature provides an instant and reliable method to confirm the authenticity of a certificate, protecting against forgery and fraud.</p>
                            ...
                            <p>If you have any questions about our security practices, please contact us at: <a href="mailto:security@mywall.com">security@mywall.com</a>.</p>
                        </div>
                    </div>
                </section>
            </main>
